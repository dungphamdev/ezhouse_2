...
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <p class="para-1">Our agents are licensed professionals that specialize in searching, negotiating of
                        real estate for rent. Our mission statement is to provide superior living experiences to all our
                        customer with the highest level of customer service, value and quality housing.</p>
    ...
    <section id="our-story">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="story">OUR AGENTS</h1>
                    <p class="pera">Our agents are licensed professionals that specialize in searching, negotiating of real
                        estate for rent. Our mission statement is to provide superior living experiences to all our customer
                        with the highest level of customer service, value and quality housing.</p>
